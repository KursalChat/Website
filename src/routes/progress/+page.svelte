<script lang="ts">
  ...
  const milestones: Milestone[] = [
    ...
    },
    {
      title: "Prototype",
      description:
        "Completed first working prototype demonstrating core functionality.",
      date: "January 1, 2026",
      status: "completed",
      icon: FlaskConical,
    },
    {
      title: "Internal API",
      description:
        "Building the core API layer that powers all client interactions.",
      status: "in-progress",
      icon: Server,
      subtasks: [
        { label: "Friend Adding", done: false },
        { label: "Messages", done: false },
        { label: "Files", done: false },
        { label: "Calls", done: false },
      ],
    },
    {
      title: "Interface",
    ...
    },
    {
      ...
      description:
        "One-to-many broadcasting for announcements and public channels.",
      status: "future",
      icon: Radio,
    },
  ];
